...
def consensus_subparser(subparsers):
    ...
    optional_args.add_argument(
        ...
        nargs="+",
        default=[],
        help="protein alignments in GFF3 format [accepts multiple files: space separated]",
        metavar="",
    )
    optional_args.add_argument(
        "-t",
        ...
        nargs="+",
        default=[],
        help="transcripts alignments in GFF3 format [accepts multiple files: space separated]",
        metavar="",
    )
    optional_args.add_argument(
        "-r",
    ...
    optional_args.add_argument(
        ...
        nargs="+",
        default=[],
        help="user supplied source weights [accepts multiple: space separated source:weight]",
        metavar="",
    )
    optional_args.add_argument(
        "-m",
        "--minscore",
        type=int,
        help="minimum score to retain gene model (default: auto)",
        metavar="",
    )
    optional_args.add_argument(
        "--repeat-overlap",
...
def convert_subparser(subparsers):
    ...
    optional_args.add_argument(
        "-o",
        "--out",
        help="write converted output to file (default: stdout)",
        metavar="",
    )
    optional_args.add_argument(
        "--input-format",
        dest="input_format",
        help="format of input file [gff3, gtf, tbl]. (default: auto)",
        choices=["gff3", "gtf", "tbl"],
        metavar="",
    )
    optional_args.add_argument(
        "--output-format",
    ...
    optional_args.add_argument(
        "--organism", help="Organism name, eg. 'Aspergillus fumigatus'", metavar=""
    )
...
def sort_subparser(subparsers):
    ...
    optional_args = group.add_argument_group("Optional arguments")
    optional_args.add_argument(
        "-o", "--out", help="write sorted output to file (default: stdout)", metavar=""
    )
...
def rename_subparser(subparsers):
    ...
    optional_args.add_argument(
        ...
        default=1,
        type=int,
        help="start locus tag numbering",
        metavar="",
    )
...
def stats_subparser(subparsers):
    ...
    optional_args.add_argument(
        "--input-format",
        dest="input_format",
        help="format of input file [gff3, tbl]. (default: auto)",
        choices=["gff3", "tbl"],
        metavar="",
    )
    optional_args.add_argument(
...
def compare_subparser(subparsers):
    ...
    required_args.add_argument(
        ...
        "--query",
        required=True,
        help="query annotation in GFF3 format",
        metavar="",
    )
    required_args.add_argument(
        "-r",
